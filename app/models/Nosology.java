...
public class Nosology extends GenericModel {
	...
	@Column
	@ManyToMany
	@JoinTable(name = "nosology_complaint_types", joinColumns = @JoinColumn(name = "nosology_id", referencedColumnName = "nosology_id"), inverseJoinColumns = @JoinColumn(name = "complaint_type_id", referencedColumnName = "complaint_type_id"))
	...
	public int hashCode() {
		...
		result = prime * result
				+ ((nosologyId == null) ? 0 : nosologyId.hashCode());
		result = prime * result
				+ ((nosologyName == null) ? 0 : nosologyName.hashCode());
		return result;
	}
