...
$(function() {
	...
	var surveyObjectId = ${survey.syndrome._key()}; //$('#choose-survey-obj').val();

	var selectAction = #{jsAction @showComplaints(':syndromeId', ':surveyId') /};
	$('#tabs-1').load(selectAction({syndromeId: surveyObjectId, surveyId: ${survey.surveyId}}));

	var selectAction = #{jsAction @showAnalysis(':syndromeId', ':surveyId') /};
	$('#tabs-2').load(selectAction({syndromeId: surveyObjectId, surveyId: ${survey.surveyId}}));

	var selectAction = #{jsAction @showClinicalManifestations(':syndromeId', ':surveyId') /};
	$('#tabs-3').load(selectAction({syndromeId: surveyObjectId, surveyId: ${survey.surveyId}}));

	var selectAction = #{jsAction @showTreatments(':syndromeId', ':surveyId') /};
	$('#tabs-4').load(selectAction({syndromeId: surveyObjectId, surveyId: ${survey.surveyId}}));

	var selectAction = #{jsAction @showNosology(':syndromeId', ':surveyId') /};
	$('#tabs-5').load(selectAction({syndromeId: surveyObjectId, surveyId: ${survey.surveyId}}));
